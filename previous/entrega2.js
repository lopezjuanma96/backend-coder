...
productos= new Contenedor("./productosCont.json")

console.log(productos.getAll());
productos.save({title:"pera", price:15, thumbnail:"pera.png"})
    .then((r) => console.log(productos.getAll()))
    .then((r) => console.log(productos.getById(1)))
    .then((r) => productos.deleteById(1)
        .then((r) => console.log(productos.getById(1)))
        )
