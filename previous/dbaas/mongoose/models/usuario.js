...
const userSchema = new mongoose.Schema({ //this object can be passed as props object from another
...
export const users = mongoose.model(userCollection, userSchema) //this is the DAO
